...
const quit_quiz = result_box.querySelector(".resultbtn .resultquit");
...
//    userScore = 0;
//    widthValue = 0;
//    showQuetions1(que_count);showQuetions2(que_count);showQuetions3(que_count);
//    showQuetions4(que_count);showQuetions5(que_count);showQuetions6(que_count);
//    showQuetions7(que_count);showQuetions8(que_count);showQuetions9(que_count);
//    queCounter1(que_numb);queCounter2(que_numb);queCounter3(que_numb);
//    queCounter4(que_numb);queCounter5(que_numb);queCounter6(que_numb);
//    queCounter7(que_numb);queCounter8(que_numb);queCounter9(que_numb);
//    clearInterval(counter);
//    clearInterval(counterLine);
//    startTimer1(timeValue);startTimer2(timeValue);startTimer3(timeValue);
//    startTimer4(timeValue);startTimer5(timeValue);startTimer6(timeValue);
//    startTimer7(timeValue);startTimer8(timeValue);startTimer9(timeValue);
//    startTimerLine(widthValue);
//    timeText.textContent = "Time Left";
//    next_btn1.classList.remove("show");next_btn2.classList.remove("show");next_btn3.classList.remove("show");
//    next_btn4.classList.remove("show");next_btn5.classList.remove("show");next_btn6.classList.remove("show");
//    next_btn7.classList.remove("show");next_btn8.classList.remove("show");next_btn9.classList.remove("show");
//}
...
//quit_quiz.onclick = ()=>{   location.href='index.html'   }
//timer line
